# AzaLoop V12.2 循环规则 — GitHub Copilot

> 本文件由 `aza setup --client GitHub Copilot` 从 `templates/_shared/v12.2-rules.md` 生成。
...
- 规则文件路径：`github-copilot/.github/copilot-instructions.md`
- 客户端能力 tier：T2（T1 全自动 / T2 部分 / T3 基础——本客户端已升级为全自动）
