# AzaLoop V12.2 循环规则 — Claude Code

> 本文件由 `aza setup --client Claude Code` 从 `templates/_shared/v12.2-rules.md` 生成。
...
- 规则文件路径：`claude-code/CLAUDE.md`
- 客户端能力 tier：T1（T1 全自动 / T2 部分 / T3 基础——本客户端已升级为全自动）
